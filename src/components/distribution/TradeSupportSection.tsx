...
function TradeSupportCard({ title, description, index }: TradeSupportCardProps) {
  return (
    <motion.article
      ...
      className="
        group flex min-h-[240px] flex-col rounded-3xl bg-[#f8faf8] p-5
        ring-1 ring-[#e3ebe6]
        transition-all duration-200
        hover:bg-white hover:shadow-[0_12px_28px_rgba(6,63,50,0.08)]
      "
    >
  ...
  return (
    <section className="bg-white py-20 md:py-24">
      <div className="site-container grid items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
        <AnimateOnScroll animation="fadeLeft" distance={32} className="relative h-[560px] overflow-hidden rounded-[32px] bg-[#f5f5f3] shadow-[0_18px_45px_rgba(6,63,50,0.12)]">
          <Image
          ...
          <motion.div
            ...
            className="absolute bottom-5 left-5 right-5 rounded-2xl bg-white/92 p-5 backdrop-blur-md"
          >
        ...
        <div>
          ...
          <AnimateOnScroll animation="fadeUp" delay={0.08} distance={26}>
            <p className="mt-5 text-[15px] leading-8 text-[#6f827b]">
              Điểm khác biệt của Samtramy là không chỉ bán hàng cho đối
              tác, mà còn đồng hành trong cách đưa sản phẩm vào kệ, vào
              tư vấn và vào kế hoạch tái nhập.
            </p>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="fadeUp" delay={0.18} distance={24}>
            <div className="mt-8">
              <a href="#partner-form">
                <Button
                  type="button"
